...
class Security {
    ...
    static async generateSHA256withRSAHeader(url, params, method, strContentType, appId, keyCertContent, keyCertPassphrase){
    ...
    static async generateAuthorizationHeader(url, params, method, strContentType, authType, appId, keyCertContent, passphrase){
        if (authType == "L2") {
            return this.generateSHA256withRSAHeader()(url, params, method, strContentType, appId, keyCertContent, passphrase);
        }
        else {
            return "";
        }
    ...
    static async verifyJWS(jws, publicCert){
        try {
    ...
    static async decryptJWE(header, encryptedKey, iv, cipherText, tag, privateKey){
